package net.idk.mcdirt.e.bEntity._0;
...
public class CobblestoneCraftingMenu extends RecipeBookMenu<CraftingInput, CraftingRecipe> {
    ...
    public CobblestoneCraftingMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public CobblestoneCraftingMenu(int containerId, Inventory playerInventory, ContainerLevelAccess access) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, B.BLOCK_ENTITIES[0].get());
    }
